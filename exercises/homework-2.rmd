...
a<-data.frame(fish_len,names(fish_len))
b<-data.frame(repunits,names(repunits))

hmm<-merge(a,b, by.x="names.fish_len.",by.y="names.repunits.")

fish_lr<-hmm$fish_len
names(fish_lr)<-hmm$repunits

fish_lr
# I know there is an easier way to do this but I guess that is why I am taking this class!
