...
submit_answer({
z[c(!is.na(z))]           #  <- put your answer to the left of the #. 
}, subprob = "-a")
...
submit_answer({
fish_lr <- fish_len
names(fish_lr) <- repunits[c(names(fish_len))]
fish_lr
}, subprob = "-b")
...
submit_answer({
fish_lr[c(names(fish_lr) == "MidOregonCoast")]
}, subprob = "-c")
