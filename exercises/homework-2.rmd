...
submit_answer({
as.numeric(na.omit(z))   #  <- put your answer to the left of the #.
# or
z[!is.na(z)]
}, subprob = "-a")
...
submit_answer({
    ...
    g[c(FALSE, TRUE)]<-g[c(FALSE, TRUE)]*2
    g[c(TRUE, FALSE)]<-g[c(TRUE, FALSE)]*3
    g
