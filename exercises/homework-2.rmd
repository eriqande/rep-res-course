...
# return it.
submit_answer({
  fish_lr<-repunits[names(fish_len)]
  fish_lr
...
submit_answer({
  fish_len[fish_lr=="MidOregonCoast"]

}, subprob = "-c")

# Bonus question: Why can't you get those 9 fish lengths by doing this: fish_len["MidOregonCoast"] ?
# because fish_len does not have repunit names associated with it.  Those names are only in fish_lr.  
```
