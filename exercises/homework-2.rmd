...
submit_answer({
           z[is.na(z)==FALSE]   #  <- put your answer to the left of the #. 
}, subprob = "-a")
...
submit_answer({
  names(repunits)=pops; repunits[fish_seq]
}, subprob = "-a")
...
# return it.
submit_answer({
  fish_lr<-repunits[names(fish_len)]; fish_lr
}, subprob = "-b")
