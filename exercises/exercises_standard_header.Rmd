...
the rep-res-course repository to get this assignment:
    ...
    * _If you already have a clone of the rep-res-course repository_
        ...
        on the master branch), then __commit any changes on whatever branch you are on__, and then checkout
        the master branch (this can be done by clicking on the branch name in the upper right of the Git pane
        and choosing).  If you don't commit changes on the branch you are on, then they will get carried back
        to the master branch and could cause problems pulling.  
        1. Now, __this is important__, immediately go to the “Tools” menu item in RStudio and within it choose "Shell...". This will pop up a command prompt window (Terminal window on a mac. GitBash Window or a Command Prompt Window on PC).
1. checkout a new branch named `r rr_branch_name` to do your work in
