...
These are just a few basic ones because I want to get this to Anthony quickly
...
# gname vector
submit_answer({
ifelse(gnames>"github", "zzzz", gnames)
})
```
