...
submit_answer({ gnamesafterboolean <- {gnames > c("github")}
})
...
# the word "github" alphabetically
submit_answer({  gnamesafter <- {gnames[gnames > c("github")]}
...
# gname vector
submit_answer({ gnames[gnames>c("github")] = "zzzz"
...
submit_answer({ gnamesord <- c(gnames[ords[1]], gnames[ords[2]], gnames[ords[3]], gnames[ords[4]])
