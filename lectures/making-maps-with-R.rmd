...
transformation in the gradient we using the `trans` argument
```{r}
...
santa cruz region, and it sort of works scale-wise, but if we had more to zoom in, it would
be tough.  

```{r, eval=FALSE}
eb2 + xlim(-123, -120.5) + ylim(36, 38)
```
