...
```{r, include = FALSE}
library(knitr)
opts_chunk$set(fig.width=10, fig.height=7, out.width = "600px", out.height = "420px")
```
...
* Please download/install these before coming to class:
    1. install necessary packages:
        ```{r, eval = FALSE}
        install.packages("ggplot2","lubridate", "plyr", "mosaic", "mosaicData")
        ```
...
can define the points along it as follows:
    ...
    # holy cow! did you see how we got  sequence of dates? lubridate is sick!
...
3. Add that line to the plot as colored points atop a black line.
    ...
    Notice how the color of Nation gets applied to it automatically.
